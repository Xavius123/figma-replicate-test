      ...
      <section className='text-center py-20 px-4'>
        <div className='max-w-4xl mx-auto'>
          ...
          <p className='text-xl text-slate-600 max-w-3xl mx-auto mb-8 leading-relaxed'>
            See how shadcn/ui components and Tailwind CSS work together to
            create beautiful, responsive interfaces that match your Figma
            designs perfectly.
          </p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                    ...
                    <NavigationMenuContent>
                      <div className='p-4 w-48'>
                        <p className='text-sm text-slate-600'>
                          Learn how to get started with shadcn/ui
                        </p>
                      </div>
                    </NavigationMenuContent>
                  </NavigationMenuItem>
          ...
          <Card className='hover:shadow-lg transition-all duration-300 hover:-translate-y-1'>
            <CardHeader>
              ...
              <CardDescription>Content containers with headers</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className='hover:shadow-lg transition-all duration-300 hover:-translate-y-1 md:col-span-2 lg:col-span-1'>
            <CardHeader>
              ...
              <CardDescription>Try the components yourself</CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              <div className='space-y-2'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <Card className='text-center'>
              <CardContent className='pt-6'>
                ...
                <p className='text-sm text-slate-600'>
                  Copy Figma measurements directly to Tailwind classes for
                  instant results.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className='text-center'>
              <CardContent className='pt-6'>
                ...
                <p className='text-sm text-slate-600'>
                  Custom colors, spacing, and typography that match your Figma
                  tokens.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className='text-center'>
              <CardContent className='pt-6'>
                ...
                <p className='text-sm text-slate-600'>
                  Accessible, responsive, and optimized components out of the
                  box.
                </p>
              </CardContent>
            </Card>
